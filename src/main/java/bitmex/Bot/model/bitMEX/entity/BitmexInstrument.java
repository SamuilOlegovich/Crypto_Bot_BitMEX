...
import bitmex.Bot.model.bitMEX.client.ZonedDateTimeDeserializer;
...
public class BitmexInstrument {
    ...
    protected double indicativeFundingRate;     // ориентировочная ставка финансирования
    protected double fundingRate;               // Скорость фондирования
