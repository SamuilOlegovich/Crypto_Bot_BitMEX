...
//            countPriseBuy.setPriceStartBuy(Gasket.getBitmexQuote().getAskPrice());
//            addStringsInListDirections(true);
        } else {
...
//            if (oneStartFlag) {
//                countPriseSell.setPriceStartSell(Gasket.getBitmexQuote().getBidPrice());
//            } else
            if (!oneStartFlag) {
...
//            priceStartBuy = Gasket.getBitmexQuote().getAskPrice();
...
//            priceStartSell = Gasket.getBitmexQuote().getAskPrice();
