...
public class BitmexRestClientTest {
    ...
    public void testSubmitOrder() throws Exception {
        ...
        doReturn(mockResponse).when(testClient).submitRequestWithBody("order", order, POST);
    ...
    public void testCancelOrder() throws Exception {
        ...
        doReturn(mockResponse).when(testClient).submitRequestWithBody("order", cancelOrder, DELETE);
    ...
    public void testAmendOrder() throws Exception {
        ...
        doReturn(mockResponse).when(testClient).submitRequestWithBody("order", order, PUT);
        when(mockResponse.readEntity(BitmexOrder.class)).thenReturn(returnOrderObject);
    ...
    public void testSubmitRequestWithBody_NotGet() throws Exception {
        String responseString = " {\"orderID\":\"f8c697c4-ca11-13f6-c601-b00cc3b600bf\"" +
                ",\"clOrdID\":\"\",\"clOrdLinkID\":\"\",\"account\":72539,\"symbol\":\"XBTUSD\"," +
                "\"side\":\"Buy\",\"simpleOrderQty\":null,\"orderQty\":2.0,\"price\":1.55," +
                "\"displayQty\":null,\"stopPx\":null,\"pegOffsetValue\":null,\"pegPriceType\":\"\"" +
                ...
                "\"ordRejReason\":\"\",\"simpleLeavesQty\":0.0001,\"leavesQty\":1,\"simpleCumQty\":0," +
                "\"cumQty\":0,\"avgPx\":null,\"multiLegReportingType\":\"SingleSecurity\"," +
                "\"text\":\"Submitted via API.\",\"transactTime\":\"2018-05-10T00:07:05.873Z\"," +
                "\"timestamp\":\"2018-05-10T00:07:05.873Z\"}";
        BitmexOrder order = new BitmexOrder();
        ...
        assertEquals( mockResponse, testClient.submitRequestWithBody("order", order, POST));
    ...
    public void testSubmitRequestWithBody_NotGet_ThrowsException() throws Exception {
        ...
        try {
            testClient.submitRequestWithBody("order", order, POST);
            fail();
    ...
    public void testSubmitRequestWithBody_Get() {
        try {
            testClient.submitRequestWithBody("", this, GET);
            fail();
